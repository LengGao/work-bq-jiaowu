      ...
      <section class="right-container">
        <header>
          ...
          <div class="userTable" style="margin-top:20px">
            <el-table
              ref="multipleTable"
              :data="imgData"
              style="width: 700%;margin-bottom:20px"
              height="400px"
              class="min_table"
              @row-click="rowClick"
            ...
            >
              <el-table-column label width="35">
                <template slot-scope="scope">
                  <el-radio :label="scope.row.url" v-model="radioUrl"
                    >&nbsp;</el-radio
                  >
        ...
        <!-- <div class="table_bottom">
          <div>
            ...
            <el-button type="primary" @click="multiDownLoad"
              >批量下载</el-button
            >
          </div>
        ...
        >
          ...
          <span slot="footer" class="dialog-footer">
            ...
            <el-button type="primary" @click="transformConfirm"
              >确 定</el-button
            >
          </span>
        </el-dialog>
...
export default {
  ...
  methods: {
    rowClick(zx) {
      console.log(zx)
      this.radioUrl = zx.url
      this.image_id = zx.image_id
      // this.$emit('setUrl', zx.url)
    },
    cancelmine() {
      this.$emit('clearUrl')
    },
    determine() {
      console.log(this.radioUrl, this.image_id)
      this.$emit('closeImg', this.radioUrl, this.image_id)
    },
    imgSuccess() {
