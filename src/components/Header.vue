  ...
  <section class="header" id="header">
    <div style="margin:12.5px 0 12.5px 65px;width:139px;height:40px;float:left">
      <a href="javascript:void(0);" style="margin-top:12.5px">
        <img src="../assets/images/logo_head.png" alt class="header_left fl" id="nav_img" />
      </a>
    </div>

    <el-dropdown class="header_right fr" @command="clickCommand" trigger="click">
...
#header {
  ...
  left: 0;
  height: 65px;
  -webkit-box-shadow: 0px 1px 1px #74797a77;
  -moz-box-shadow: 0px 1px 1px #74797a77;
