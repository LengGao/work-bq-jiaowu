<template>
  <section class="main">
    <div class="client_head">
      <search :hideTime="true" :hideOtherOption="true" :selectItems="true" api="videocollectionlist" :selectList="selectData.list" placeholder="课程分类" @getTable="getTable"></search>
    </div>
    <!--表格-->
    <div class="userTable">
      <el-table ref="multipleTable" :data="dataList.data" style="width: 100%" class="min_table" @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="course_category_name" label="注册时间" min-width="150" show-overflow-tooltip align="center"></el-table-column>
        <el-table-column prop="video_collection_number" label="成交状态" min-width="70" show-overflow-tooltip align="center"></el-table-column>
        <el-table-column prop="video_collection_number" label="所属校区" min-width="70" show-overflow-tooltip align="center"></el-table-column>
