      ...
      >
        ...
        <el-form-item prop="code" style="margin-bottom:20px;text-align: center">
          <div style="display:flex;align-item:center">
            ...
            <img :src="verifyCode" alt="" style="width:30%;height:40px" />
          </div>
          <span
            style="position:absolute;right:0;top:40px;font-size: 12px;color: rgb(25, 159, 255);cursor:pointer"
            @click="change"
            >看不清，换一张</span
          >
        </el-form-item>
        ...
        <el-form-item style="margin-bottom:48px;text-align: center">
          <router-link to="/index" style="color:#199FFF">>>去登录</router-link>
        </el-form-item>
      </el-form>
    </el-card>
