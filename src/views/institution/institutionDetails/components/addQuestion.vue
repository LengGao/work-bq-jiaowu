...
<script>
import { assignOrgQuestionBank } from "@/api/institution";
import { getCateList } from "@/api/sou";
import { cloneOptions } from "@/utils/index";
import { getOrgQuestionBankList } from "@/api/sou";
export default {
  props: {
    value: {
      type: Boolean,
  ...
  methods: {
    ...
    handleOpen() {
      this.getOrgQuestionBankList(), this.getCateList();
    ...
    async getOrgQuestionBankList() {
      ...
      const res = await getOrgQuestionBankList(data);

      this.listLeftLoading = false;
      this.listLeftTotal = res.data.total;
      this.listLeftData = res.data.list;
