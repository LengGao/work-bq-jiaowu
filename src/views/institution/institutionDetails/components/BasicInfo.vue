    ...
    <div class="college-student-container">
      ...
      <div class="table-list">
        ...
        <div class="college-student-search">
          ...
          />
          <span>*注意：价格为0表示该班型免费，价格为-1表示该班型不能报名 </span>
...
export default {
  ...
  methods: {
    async hanldePriceBlur({ class_type, course_id }) {
      const course_id_arr = {
        [course_id]: {},
      };
      class_type.forEach((item) => {
        course_id_arr[course_id][item.id] = item.price || -1;
      });
