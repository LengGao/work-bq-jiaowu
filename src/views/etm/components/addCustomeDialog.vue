<template>
  <!--添加客户弹框--->
  <section>
    <el-dialog title="添加客户" :visible.sync="openStatus" width="65%" :close-on-click-modal="false" @close="doClose" @open="handleOpen">
      <el-form label-width="110px" class="info-form" :show-message="true" :model="ruleForm" :rules="rules" ref="ruleForm">
        ...
        <el-form-item label="备用号码" prop="second_mobile">
          <el-input class="input-width" v-model="ruleForm.second_mobile"></el-input>
        </el-form-item>

        <el-form-item label="身份证号" prop="id_card_number">
          <el-input class="input-width" v-model="ruleForm.id_card_number"></el-input>
        </el-form-item>

        <el-form-item label="出生日期" prop="birthday">
          <el-date-picker v-model="ruleForm.birthday" type="date" format="yyyy-MM-dd " value-format="yyyy-MM-dd " style="width: 240px" placeholder="选择日期">
          </el-date-picker>
        </el-form-item>
        ...
        <el-form-item label="文化程度" prop="culture">
          <!-- <el-input
                  ...
                  ></el-input> -->
          <el-select v-model="ruleForm.culture" placeholder="请选择文化程度" class="input-width">
            <el-option v-for="item in cultures" :key="item.value" :label="item.label" :value="item.label">
            </el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="籍贯" prop="province">
          <el-cascader size="large" class="input-width" :options="provinceAndCityData" v-model="selectedOptions" @change="handleChange">
          </el-cascader>
        </el-form-item>
        <el-form-item label="常住地" prop="city">
          <el-cascader size="large" class="input-width" :options="provinceAndCityData" v-model="selectedOptionsLocal" @change="handleLocal">
          </el-cascader>
          <!-- <el-input
                class="input-width"
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="preserve('ruleForm', 2)">保 存</el-button>
        <el-button type="primary" @click="preserve('ruleForm')">保存并报名</el-button>
      </span>
    </el-dialog>
    <customeRegist v-model="addVisible" :userInfo="userInfo" v-on:addDialog="getaddStatus($event)" />
  </section>
</template>
