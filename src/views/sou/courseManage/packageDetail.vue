          ...
          <el-row>
            <el-col :sm="12">
              <el-form-item label="热门推荐" prop="is_hot">
                <el-radio-group v-model="ruleForm.is_hot" disabled>
                  <el-radio :label="1">是</el-radio>
                  <el-radio :label="2">否</el-radio>
                </el-radio-group>
              </el-form-item>
...
export default {
  ...
  mounted() {
    ...
    if (Meal == '2') {
      ...
      this.setMeal = true
      this.$route.meta.title = '套餐班详情'
      this.ruleForm.class_type = 2
    } else {
      this.ruleForm.class_type = 1
      this.setMeal = false
      this.$route.meta.title = '单科班详情'
    }
    if (this.course_id != '') {
