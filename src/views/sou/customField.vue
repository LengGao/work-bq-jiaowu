    ...
    <div class="mainwrap main">
      <div class="left-container">
        ...
        <div class="enrollment-info" style="margin-top:20px">
          <h2>学籍信息</h2>
          <ul>
            <li v-for="item in enrollData" :key="item.id">{{ item.name }}</li>
          </ul>
        </div>
      </div>
      <section class="main-right">
        <div class="client_head">
          ...
          ></search2> -->
          <el-button type="primary" @click="addClassiFion">添加</el-button>
        </div>
        <!--表格-->
        <div class="userTable">
          <el-table
