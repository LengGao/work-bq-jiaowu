  ...
  <div class="class-detail">
    ...
    >
      ...
      >
        <el-alert
          :closable="false"
          title="注意：通过机构端公众号发送的通知内容里面的所有“北区教育”文字将会被去除，所有“东培学堂”的文字内容将会替换成该机构的名称，请注意填写的内容是否与机构小程序的操作步骤一致！"
          type="warning"
          style="margin: -20px 0 10px 30px; width: calc(100% - 30px)"
        >
        </el-alert>
