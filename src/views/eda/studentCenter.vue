    ...
    <div class="mainPart">
      ...
      <div>
        <!-- <el-button style="margin-right: 20px" @click="handleBatch"
          >批量分班</el-button
        > -->
        <el-checkbox v-model="checked" @change="handleChecked">未分班学生</el-checkbox>
      </div>
      <!--列表-->
      <div class="userTable">
        <el-table ref="multipleTable" :data="listData" v-loading="listLoading" element-loading-text="loading" element-loading-spinner="el-icon-loading" element-loading-background="#fff" tooltip-effect="light" stripe style="width: 100%" class="min_table" :header-cell-style="{ 'text-align': 'center' }" :cell-style="{ 'text-align': 'center' }" @selection-change="handleSeletChange">
          <el-table-column type="selection" width="55"> </el-table-column>
          <el-table-column prop="uid" label="ID" show-overflow-tooltip min-width="90"></el-table-column>
          <el-table-column prop="realname" label="学生姓名" min-width="100" show-overflow-tooltip>
          ...
          <el-table-column prop="institution_name" label="推荐机构" min-width="150" show-overflow-tooltip></el-table-column>
          <!-- <el-table-column
            prop="schoole_name"
            label="所属校区"
            min-width="100"
          ...
          ></el-table-column> -->
          <el-table-column prop="classroom_name" label="所属班级" min-width="230" show-overflow-tooltip>
            <template slot-scope="{ row }">
              <span>{{
          ...
          <el-table-column prop="create_time" label="创建时间" min-width="110" show-overflow-tooltip></el-table-column>
          <el-table-column label="操作" fixed="right" min-width="200">
            <template slot-scope="{ row }">
              <div style="display: flex; justify-content: center">
                <el-button type="text" @click="toStudentDetail(row.uid)">学生详情</el-button>
              </div>
            </template>
          </el-table-column>
        </el-table>
